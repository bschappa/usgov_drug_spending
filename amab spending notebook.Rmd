...
mcb_cleaned <- as_tibble(mcb_raw, .name_repair = to_any_case) %>%
...
mcd_cleaned <- as_tibble(mcd_raw, .name_repair = to_any_case) %>%
...
ma_cleaned <- as_tibble(ma_raw, .name_repair = to_any_case) %>%
